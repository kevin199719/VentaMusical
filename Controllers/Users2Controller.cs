...
namespace VentaMusical.Controllers
{
    public class Users2Controller : Controller
    {
        ...
        public Users2Controller(VentaMusicalContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("UserId,UserIdentification,UserName,UserGender,UserEmail,UserAlias")] User user)
        {
